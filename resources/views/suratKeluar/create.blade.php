...
<div class="container-xxl flex-grow-1 container-p-y mt-5">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Surat Keluar /</span> Create Surat Keluar</h4>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <option value="Draft" {{ old('status') == 'Draft' ? 'selected' : '' }}>Draft</option>
                            <option value="Proses Persetujuan" {{ old('status') == 'Proses Persetujuan' ? 'selected' : '' }}>Proses Persetujuan</option>
